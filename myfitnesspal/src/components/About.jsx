          ...
          <Box className="box2">
            ...
            <Box className="box4">
              <Text>
                ...
                card - you'll never have to pay a cent. <br /> Study after study
                ...
                best, or simply impossible at worst. <br /> At MyFitnessPal.com,
            ...
            <br />
            <Box className="box6">
              <Text size="xl">With a FREE membership you get:</Text>
            </Box>
            <br />
            <Box className="box7">
              <Text>
                <b>✅The easiest to use food diary on the web -</b>Track what
                you eat with just a few clicks from anywhere with an internet
              ...
              <Text>
                <b>✅Free mobile apps for iPhone and Android - </b>so you can
                log your meals and exercise even when you are on the go
              </Text>
              <Text>
                <b>✅Support and motivation</b>from people just like you - Our
